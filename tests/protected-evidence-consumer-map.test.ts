...
const CUTOVER_PRODUCER_SHA = "d7a2e049e3b162799654ffe80f64284f65fb59e1";
...
const WORKFLOW_DIGESTS: Record<string, string> = {
  ...
  ".github/workflows/trusted-deploy.yml": "2067b69dcaf294bf19a786a4ea2e7a73fee65ffe1faafa36a51b84675d738d40",
