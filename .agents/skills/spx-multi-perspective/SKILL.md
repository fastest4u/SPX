---
name: spx-multi-perspective
description: Compare SPX technical options before a decision. Use when the user invokes `$spx-multi-perspective`, asks for multi-perspective, chooses between approaches, writes an ADR, or when a decision feels too easy.
---
