...
export const env = {
  ...
  LINE_SERVICE_REQUEST_TIMEOUT_MS: readIntegerEnv("LINE_SERVICE_REQUEST_TIMEOUT_MS", 5000),
  ...
  BIDDING_LIST_FETCH_EXTRA_PAGES: process.env.BIDDING_LIST_FETCH_EXTRA_PAGES === "true",
