...
export const teams = mysqlTable("teams", {
  ...
  spxEmail: varchar("spx_email", { length: 254 }).notNull().default(""),
  spxPassword: text("spx_password"),
  spxAuthStatus: varchar("spx_auth_status", { length: 24 }).notNull().default("manual"),
  spxAuthError: varchar("spx_auth_error", { length: 48 }),
  spxAuthRetryAt: datetime("spx_auth_retry_at"),
  spxAuthFailures: int("spx_auth_failures").notNull().default(0),
  spxSessionExpiresAt: datetime("spx_session_expires_at"),
  spxLastLoginAt: datetime("spx_last_login_at"),
  spxAuthEpoch: int("spx_auth_epoch").notNull().default(0),
  spxAuthLeaseToken: varchar("spx_auth_lease_token", { length: 64 }),
  spxAuthLeaseUntil: datetime("spx_auth_lease_until"),
