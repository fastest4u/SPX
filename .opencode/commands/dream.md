---
description: Memory compactor — promote insights from session logs, dedupe, archive stale notes, refresh MOC. Run monthly or when session logs exceed 30 files.
---
...
10. **Write a compactor session log:**
