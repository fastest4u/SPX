---
description: Run the Memory Vault verification gate and summarize the result.
---
...
- If the command cannot run (env restriction), state that clearly and report the last known score from session logs.
