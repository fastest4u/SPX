...
10. Confirm the split worker remains alive with `docker compose --profile split ps worker-ifn-split worker-ptwl-split`; only the intentionally stopped service should be unhealthy or exited.
